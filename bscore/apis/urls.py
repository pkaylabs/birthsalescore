...
urlpatterns += [
    ...
    path('publishingcreditcoupons/', views.VendorPublishingCreditCouponAPIView.as_view(), name='publishing_credit_coupons'),
    path('redeempublishingcreditcoupon/', views.RedeemPublishingCreditCouponAPIView.as_view(), name='redeem_publishing_credit_coupon'),
    path('customercoupons/', views.VendorCustomerCouponAPIView.as_view(), name='customer_coupons'),
    path('validatecustomercoupon/', views.ValidateCustomerCouponAPIView.as_view(), name='validate_customer_coupon'),
