...
class SubscriptionPackageAdmin(admin.ModelAdmin):
    list_display = ('package_name', 'can_create_product', 'can_create_service', 'max_products', 'max_services', 'package_price')
    search_fields = ('package_name',)

@admin.register(Subscription)
class SubscriptionAdmin(admin.ModelAdmin):
    list_display = ( 'id', 'vendor', 'vendor_id', 'package', 'expired', 'start_date', 'end_date')
